...
export default function HomePage() {
  ...
  const heroSlides = [
    {
      id: 1,
      title: "Welcome to Mala King Hot Pot!",
      subtitle: "Surrey's Premier Hot Pot Destination",
      description: "Experience authentic hot pot flavors with our signature Ma La Tang broth and premium ingredients. Choose from over 100 fresh ingredients and 10+ flavorful broths. Your perfect hot pot experience awaits!",
